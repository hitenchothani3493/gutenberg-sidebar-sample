...
module.exports = {
  entry: {
    './assets/js/dist/JohnnyTextControl' : './assets/js/JohnnyTextControl.js',
    './assets/js/dist/JohnnyToogleControl' : './assets/js/JohnnyToogleControl.js',
    './assets/js/dist/index' : './assets/js/index.js',
